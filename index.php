...
?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<!-- Here we query for our new intro custom post type and get just one single post -->
			...
			<div class="section-heading" id="food">
				<!-- Here we get our category name via the category description -->
				<?php get_category_description('category_name=menu'); ?>
			</div>

			<div class="grid">
				<?php
				// Here we make sure to override our query otherwise the one from above will still be used in this loop
